    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Ink.Spacing.lg) {
            ...
            iconRow(theme: .dark)
                ...
                // Replaced hardcoded Color.black with the design-system token.
                // Light mode: elevates above the surrounding cream surface
                // and gives the dark-theme icons a contrasting backdrop.
                // Dark mode: a touch lighter than the page bg so the
                // preview row reads as a distinct surface.
