...
extension StorageService {
    ...
    nonisolated static func writeFile(_ data: Data, to url: URL) throws {
    ...
    nonisolated static func copyFile(at source: URL, to destination: URL) throws {
    ...
    nonisolated static func removeFile(at url: URL) throws {
        guard isUsingiCloudStorage, url.path.contains("/Documents/Notebooks/") else {
