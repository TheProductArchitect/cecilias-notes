...
public extension Font {
    ...
    static let inkLargeIcon:  Font = .system(size: 22, weight: .light,    design: .default)
    static let inkTitle2:     Font = .system(size: 22, weight: .regular,  design: .default)
    static let inkSectionHero: Font = .system(size: 20, weight: .semibold, design: .default)
    static let inkSectionIcon: Font = .system(size: 20, weight: .light,   design: .default)
    static let inkLargeMetric: Font = .system(size: 28, weight: .light,   design: .default)
    static let inkMidIcon:    Font = .system(size: 18, weight: .light,    design: .default)
    ...
    static let inkRowLabel:   Font = .system(size: 14, weight: .medium,   design: .default)
    static let inkRowSelected: Font = .system(size: 14, weight: .semibold, design: .default)
    ...
    static let inkTag:        Font = .system(size: 12, weight: .medium,   design: .default)
