...
struct EditorToolbarView: View {
    ...
    var body: some View {
        ...
        .inkAnimation(InkSpring.smooth, value: viewModel.isToolbarVisible)
        ...
        HStack(spacing: Ink.Spacing.xs) {
            ...
            Button { onToggleRecordingPanel() } label: {
                Image(systemName: viewModel.isRecordingPanelVisible ? "mic.fill" : "mic")
                    ...
                    .foregroundColor(viewModel.isRecordingPanelVisible ? .inkAccent : .inkTextSecondary)
                    .frame(width: 36, height: 36)
            }
            .buttonStyle(.plain)
            ...
            Menu {
                ...
                Button {
                    onMoreMenuPageSettings()
                } label: { Label("Page Settings…", systemImage: "slider.horizontal.3") }
            ...
            SaveStatusIndicator(status: viewModel.saveStatus)
                .padding(.leading, Ink.Spacing.xs)
        }
    }
