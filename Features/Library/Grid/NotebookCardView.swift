...
struct NotebookCardView: View {
    ...
    var body: some View {
        ...
        .onHover { hovered in
            withAnimation(.inkAnimation(InkSpring.precise, value: hovered)) { isHovered = hovered }
        }
        .onTapGesture {
            if viewModel.isSelecting {
                withAnimation(.inkAnimation(InkSpring.snappy, value: isSelected)) {
    ...
    private var contextMenu: some View {
        ...
        Button {
            withAnimation(.inkAnimation(InkSpring.snappy, value: notebook.isPinned)) {
